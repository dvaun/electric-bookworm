...
gulp.task('copy:png', function(){
  return gulp.src(['src/app/**/img/*.png'], { base: 'src/'})
    .pipe(gulp.dest('dist/dev'));
});

gulp.task('copy:jpg', function(){
  return gulp.src(['src/app/**/img/*.jpg'], { base: 'src/'})
    .pipe(gulp.dest('dist/dev'));
});
...
gulp.task('copy:libjs', function(){
  return gulp.src(['src/app/**/lib/*.js'], { base: 'src/'})
    .pipe(gulp.dest('dist/dev'));
});
...
gulp.task('compile:ts', ['copy:typings', 'compile:sass', 'copy:html', 'copy:css'], function() {
...
gulp.task('serve', ['build'], function() {
  ...
  gulp.watch(['src/**/lib/*.js'], ['copy:libjs']);
  gulp.watch(['src/index.html'], ['copy:index']);
  gulp.watch(['src/**/img/*.png'], ['copy:png']);
  gulp.watch(['src/**/img/*.jpg'], ['copy:jpg']);
